//
//  FMVideoPreviewCollectionViewCell.m
//  PhotoKitApplication
//
...
@interface FMVideoPreviewCollectionViewCell ()
{
    BOOL _played;
    NSString *_totalTime;
...
@implementation FMVideoPreviewCollectionViewCell

- (void)awakeFromNib {
    
    // 添加通知
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(changePag) name:@"changePag" object:nil];
...
- (void)changePag{
    ...
    if (self.playerItem == nil || self.playerView == nil) {
        return;
    }
